...
microSD and the image to eMMC storage using the latest version (at least
2025-03-07) of `rkdeveloptool`:
...
Flash `u-boot` to SPI NOR flash and the image to eMMC storage using the latest
