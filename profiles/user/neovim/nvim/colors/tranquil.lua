...
local groups = {
  ...
  Todo = { fg = shade[1], bg = shade[3], italic = true },
  Function = { fg = accent[2] },
  Number = { link = 'Constant' },
  Boolean = { fg = accent[4], bold = true },
  Float = { link = 'Number' },
  Label = { fg = accent[1], italic = true },
  ...
  ['@lsp.typemod.function.defaultLibrary'] = { link = '@constant.builtin' },
  ['@lsp.typemod.variable.global'] = { fg = accent[7], bold = true },
