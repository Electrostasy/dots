...
groups.builtin = {
  ...
  FloatBorder = { fg = palette.blue3 },
  FloatTitle = { fg = palette.blue3 },
  FloatFooter = { fg = palette.blue3 },
  ...
  -- PmenuExtra = {},
  -- PmenuExtraSel = {},
  PmenuSbar = { bg = palette.background3 },
...
groups.plugins = {
  ...
  -- GitSignsTopdelete = { },
  -- GitSignsUntracked = {},
  GitSignsAddCul = { fg = palette.teal1, bg = groups.builtin.CursorColumn.bg },
  GitSignsChangeCul = { fg = palette.yellow, bg = groups.builtin.CursorColumn.bg },
  GitSignsDeleteCul = { fg = palette.pink2, bg = groups.builtin.CursorColumn.bg },
  GitSignsChangedeleteCul = { fg = blend(palette.yellow, palette.pink2, 0.5), bg = groups.builtin.CursorColumn.bg },
  -- GitSignsAddNr = {},
  -- GitSignsChangeNr = {},
  -- GitSignsDeleteNr = {},
  ...
  --- blink.cmp. :h blink-cmp-config-appearance
  BlinkCmpLabelMatch = { fg = palette.teal2, bold = true },
  BlinkCmpLabelDeprecated = { italic = true, strikethrough = true },
  BlinkCmpKindText = { fg = groups.common_syntax.String.fg, bg = palette.background3 },
  BlinkCmpKindMethod = { fg = groups.common_syntax.Function.fg, bg = palette.background3 },
  BlinkCmpKindFunction = { link = 'BlinkCmpKindMethod' },
  BlinkCmpKindConstructor = { fg = groups.treesitter['@constructor'].fg, bg = palette.background3 },
  BlinkCmpKindField = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindVariable = { fg = blend(palette.text, palette.blueGray1, 0.5), bg = palette.background3 },
  BlinkCmpKindClass = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindInterface = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindModule = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindProperty = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindUnit = { fg = groups.common_syntax.Number.fg, bg = palette.background3},
  BlinkCmpKindValue = { fg = groups.common_syntax.Number.fg, bg = palette.background3 },
  BlinkCmpKindEnum = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindKeyword = { fg = groups.common_syntax.Keyword.fg, bg = palette.background3 },
  BlinkCmpKindSnippet = { fg = palette.pink2, bg = palette.background3 },
  BlinkCmpKindColor = { fg = palette.pink1, bg = palette.background3 },
  BlinkCmpKindFile = { fg = palette.blue3, bg = palette.background3 },
  BlinkCmpKindReference = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindFolder = { fg = palette.blue3, bg = palette.background3 },
  BlinkCmpKindEnumMember = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindConstant = { fg = groups.common_syntax.Constant.fg, bg = palette.background3 },
  BlinkCmpKindStruct = { fg = palette.blueGray1, bg = palette.background3 },
  BlinkCmpKindEvent = { fg = palette.blue3, bg = palette.background3 },
  BlinkCmpKindOperator = { fg = groups.common_syntax.Operator.fg, bg = palette.background3 },
  BlinkCmpKindTypeParameter = { fg = groups.treesitter['@parameter'].fg, bg = palette.background3 },
